 ...
 */
public class ServerMsgServerSubscriber<T> extends DisposableSubscriber<ServerMsg<T>> {

	private ServerSubscriberListener<ServerMsg<T>> mListener;
	public int vocational_id = -1;
	public HashMap<String, Object> mExData;

	public ServerMsgServerSubscriber(ServerSubscriberListener listener) {
		mListener = listener;
	}
...
//	}
	...
	@Override
	public void onNext(ServerMsg<T> serverMsg) {
		Log.e("ObjectServerSubscriber", "onNext");
		mListener.onServerNext(vocational_id, mExData, serverMsg);
	}
