...
public class BlurUtil {
    ...
    //初始化工具箱
    private static class SingletonBlurUtil{
        private static final BlurUtil viewUtil = new BlurUtil();
    }

    //获取工具箱单例
    public static BlurUtil getViewUtil(){
        return SingletonBlurUtil.viewUtil;
    }
